...
import com.hjc.scriptutil.tools.Programe;
...
public class ProcessInfo {
	...
	private static final String LOG_TAG = "scripttool-" + ProcessInfo.class.getSimpleName();

	private static final String PACKAGE_NAME = "com.hjc.scripttool";
	...
	public List<Programe> getRunningProcess(Context context) {
		...
		List<Programe> progressList = new ArrayList<>();
...
//			Log.e(Constants.TAG,"ProcessInfo "+ programe.getProcessName() + ":"+ programe.getPid() );
		}
